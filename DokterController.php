...
class DokterController extends Controller
{
    ...
    {
        $data_dokter = DB::table('dokter')->join('unit_kerja_id','dokter.unit_kerja_id','=','unit_kerja.id')
...
// kirim array data ke view paramedik index menggunakan assosiatif array
    ...
    {
        $data= DB::table('dokter')->join('unit_kerja_id','dokter.unit_kerja_id','=','unit_kerja_id')
        ->select('dokter.*','unit_kerja_id.nama as nama_unit_kerja_id')
        ->get();
        $data_dokter = $data->where('id',$id);
        return view('dokter.detail', compact('list_dokter'));
    }
